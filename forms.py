...
audio_langs = ['English','Spanish','Cantonese','Tagalog','French','German','Mandarin','Arabic','Korean','Slovak','Thai','Turkish','Vietnamese','Russian','Portuguese','Polish']
sub_langs = ['English','Spanish','Tagalog','French','German','Arabic','Korean','Slovak','Thai','Chinese','Turkish','Vietnamese','Russian','Portuguese','Polish']
